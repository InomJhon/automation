...
#     browser.get("http://demo.guru99.com/insurance/v1/register.php")
...
#     test_registration.pick_title("Doctor")
#     test_registration.enter_first_name("Inom")
#     test_registration.enter_surname("nematov")
#     test_registration.enter_phone_number("66666")
#     test_registration.pick_year_of_birth("1986")
#     test_registration.pick_month_of_birth("March")
#     test_registration.pick_day_of_birth("22")
#     test_registration.pick_provisional()
#     #test_registration.pick_full()
#     test_registration.enter_street_and_address("1947 ocean ave")
#     test_registration.enter_city("New York")
#     test_registration.enter_country("USA")
#     test_registration.enter_post_code("111223")
#     test_registration.enter_email("aaa@gmail.com")
#     test_registration.enter_password("111")
#     test_registration.enter_confirm_password("111")
